...
```{r}
mm_abun_nat <- fxn_summarize_marginal_means("mod_abun_nat", index_link = "none", lookup_tables)  
...
```{r}
contrasts_abun_nat <- fxn_summarize_contrasts("mod_abun_nat", index_link = "none", lookup_tables)  
...
```{r}
mm_abun_frb <- fxn_summarize_marginal_means("mod_abun_frb", index_link = "none", lookup_tables)  
...
```{r}
contrasts_abun_frb <- fxn_summarize_contrasts("mod_abun_frb", index_link = "none", lookup_tables)  
...
```{r}
mm_abun_non <- fxn_summarize_marginal_means("mod_abun_non", index_link = "none", lookup_tables)  
...
```{r}
contrasts_abun_non <- fxn_summarize_contrasts("mod_abun_non", index_link = "none", lookup_tables)  
...
```{r}
mm_rich_nat <- fxn_summarize_marginal_means("mod_rich_nat", index_link = "none", lookup_tables)  
# 
...
```{r}
contrasts_rich_nat <- fxn_summarize_contrasts("mod_rich_nat", index_link = "none", lookup_tables)  
...
```{r}
mm_rich_frb <- fxn_summarize_marginal_means("mod_rich_frb", index_link = "none", lookup_tables)  
# 
...
```{r}
contrasts_rich_frb <- fxn_summarize_contrasts("mod_rich_frb", index_link = "none", lookup_tables)  
...
```{r}
mm_rich_non <- fxn_summarize_marginal_means("mod_rich_non", index_link = "none", lookup_tables)  
...
```{r}
contrasts_rich_non <- fxn_summarize_contrasts("mod_rich_non", index_link = "none", lookup_tables)  
