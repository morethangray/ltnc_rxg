...
Final models provided in table. Detailed results for model selection in subsequent sections.

Native and native forbs were identical. All three species subsets had same formula and distribution (normal). Abundance was log-transformed for native and native forb species, and square root-transformed for non-native species.
